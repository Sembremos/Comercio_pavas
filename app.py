...
with st.form("encuesta_seguridad"):
    ...
    with st.expander("Sección 3: Percepción y Relación con Fuerza Pública"):
        ...
        razon_parcial = st.text_area(" - Si su respuesta fue No o Parcialmente, ¿Por qué siente que la presencia es solo parcial o no del todo efectiva?", key="q13_razon_parcial")
